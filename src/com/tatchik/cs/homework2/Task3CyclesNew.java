...
public class Task3CyclesNew {
     ...
     */
    private static double calculateVanyaSavings(int initialSalary, int monthlyExpenses, double investmentPercentage, double monthlyReturnRate, int salaryIncrease) {
